...
function checkAnswer() {
    ...
    let isCorrect = userAnswer === calculatedAnswer[0]; // [0] because calculatedAnswer will be an array
    ...
    // runs the game again (fresh numbers)
...
function calculateCorrectAnswer() {
    // parseInt used to ensure the value is an integer
...
/**
 * gets the current correct answers from the DOM and increments it by 1
 */
...
function displayDivisionQuestion(operand1, operand2) {
    //ensures the answer to the division is a whole number
